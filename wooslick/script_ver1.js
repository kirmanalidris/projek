...
$(function(){
  var list = ["Ayo berbelanja 🎉..","Jangan sedih😁..","Rok mini korea..","Celana panjang pria..","Celana wanita..","Hoodie terbaru..","Flash deal.."],
      r = Math.floor(Math.random() * list.length);
  $('#kirman_search').prop('placeholder',list[r]);
});
$(document).ready(function(){$(".kirman_alert").slideDown();$(".kirman_alert a").click(function(){$(".kirman_alert").slideUp();});});
...
var kirman_get_flash_deal = "<?php echo get_option('flash_deal'); ?>";
...
/* Whatsapp Settings */
var kirman_wa_telpon = <?php echo get_option('nomer_whatsapp'); ?>;
...
AOS.init();
// Dark Mode
$("#kirman_nightmode, #kirman_nightmode_1").click(function(){$("body").toggleClass("kirman_nightmode")}),$("body").toggleClass(localStorage.toggled),$("#kirman_nightmode").click(function(){"kirman_nightmode"!=localStorage.toggled?($("body").toggleClass("kirman_nightmode",!0),localStorage.toggled="kirman_nightmode"):($("body").toggleClass("kirman_nightmode",!1),localStorage.toggled="")});
